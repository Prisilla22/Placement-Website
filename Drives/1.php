				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">ICEM<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>Indira College of Engineering and Management (ICEM), Pune is an AICTE approved engineering college in Pune, established in 2007 under the umbrella of Indira Group of Institutes. The institute is approved by All India Council of Technical Education (AICTE), New Delhi, recognized by Government of Maharashtra and is affiliated to SavitribaiPhule, Pune University. If you are looking for engineering admission to an engineering college in Pune, then ICEM is a wise choice. 
						</p>
					</div>
			...
			<div class="banner-bottom-grids a-banner-bottom-grids">
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
						...
						<h5></span></h5>
						<p>Indira College of Engineering and Management, Pune is one of the engineering colleges in Pune, which constitutes of 1500+ students pursuing their UG and PG degree in Engineering and Management courses. The process for engineering admission is straightforward at ICEM, and it also has a reasonable engineering admission fees. At present, the college offers undergraduate engineering programs, namely Civil Engineering, Computer Engineering, Mechanical Engineering, and post-graduate Engineering and Management programs, namely M.E in Electronics & Telecommunication Engineering- Specialization: Communication Network, M.E in Mechanical Engineering – Specialization: Heat Power, M.E in Computer Engineering.
						</p>
					</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>S.No. 64,65, Gat No. 276 At Post : Parandwadi, Near Somatne phata, Tal. : Maval, Dist. Pune – 410 506
						</p>
					</div>
					<div class="phone">
						<p>Toll Free Number : 18002102960</p>
					</div>
				</div>
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Indira College of Engineering and Management</h6>
					<h4>
