        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="https://indiraicem.ac.in/">Indira College of Engineering and Management</a>
                </div>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 ftr-logo">
					<p> Developed by
              <a href=" " target="_parent">Prisilla Bhongale</a>
              <a href=" " target="_parent">Vidya Argade</a>
              <a href=" " target="_parent">Sakshi Dhage</a>
				</div>
